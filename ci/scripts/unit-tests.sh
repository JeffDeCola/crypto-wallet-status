#!/bin/sh
# crypto-wallet-status unit-test.sh
...
echo "cd src/github.com/JeffDeCola/crypto-wallet-status"
cd src/github.com/JeffDeCola/crypto-wallet-status
echo " "
...
echo "Placeholder to run go tests for crypto-wallet-status" | tee test_coverage.txt
echo " "
