#!/bin/sh
# crypto-wallet-status unit-tests.sh
...
echo "The goal is to set up a go src/github.com/JeffDeCola/crypto-wallet-status directory"
...
echo "cp -R ./crypto-wallet-status src/github.com/JeffDeCola/."
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for crypto-wallet-status" | tee test/test_coverage.txt
# echo " "
